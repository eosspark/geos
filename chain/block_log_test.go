...
func TestBlockTest(t *testing.T) {
	...
	t.Run("", func(t *testing.T) {
		...
		block100 := blockLog.ReadBlockByNum(100)
		assert.Equal(t, block100.Confirmed, uint16(100))
