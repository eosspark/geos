...
// 	Extensions         []*types.Extension `json:"transaction_extensions"`
// }

// type TransactionPack struct {
...
// 	UnpackedTransaction   `json:"transaction"`
// }
...
// 	types.TransactionReceiptHeader
// 	Transactions TransactionAll `json:"trx"`
// }

// type BlockData struct {
// 	types.SignedBlockHeader
// 	Transactions    []TransactionResp  `json:"transactions"`
// 	BlockExtensions []*types.Extension `json:"block_extensions"`
// }
...
// 	FreeBytes common.JSONInt64 `json:"free_bytes"`
// 	UsedBytes common.JSONInt64 `json:"used_bytes"`
// 	Size      common.JSONInt64 `json:"size"`
// 	Indices   []struct {
// 		Index    string           `json:"index"`
// 		RowCount common.JSONInt64 `json:"row_count"`
// 	} `json:"indices"`
// }
