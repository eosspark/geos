...
//go:generate gotemplate -outfmt "gen_%v" "github.com/eosspark/eos-go/libraries/multiindex/multi_index_container" TransactionStateIndex(ById,ByIdNode,multi_index.TransactionState)
...
//go:generate gotemplate -outfmt "gen_%v" "github.com/eosspark/eos-go/libraries/multiindex/ordered_index" ById(TransactionStateIndex,TransactionStateIndexNode,ByExpiry,ByExpiryNode,multi_index.TransactionState,common.TransactionIdType,ByIdFunc,ByIdCompare,false)
...
//go:generate gotemplate -outfmt "gen_%v" "github.com/eosspark/eos-go/libraries/multiindex/ordered_index" ByExpiry(TransactionStateIndex,TransactionStateIndexNode,ByBlockNum,ByBlockNumNode,multi_index.TransactionState,common.TimePointSec,ByExpiryFunc,ByExpiryCompare,true)
...
//go:generate gotemplate -outfmt "gen_%v" "github.com/eosspark/eos-go/libraries/multiindex/ordered_index" ByBlockNum(TransactionStateIndex,TransactionStateIndexNode,TransactionStateIndexBase,TransactionStateIndexBaseNode,multi_index.TransactionState,uint32,ByBlockNumFunc,ByBlockNumCompare,true)
