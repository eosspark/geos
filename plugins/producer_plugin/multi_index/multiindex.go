...
//go:generate gotemplate -outfmt "gen_%v" "github.com/eosspark/eos-go/libraries/multiindex/multi_index_container" TransactionIdWithExpiryIndex(ById,ByIdNode,TransactionIdWithExpiry)
...
//go:generate gotemplate -outfmt "gen_%v" "github.com/eosspark/eos-go/libraries/multiindex/hashed_index" ById(TransactionIdWithExpiryIndex,TransactionIdWithExpiryIndexNode,ByExpiry,ByExpiryNode,TransactionIdWithExpiry,common.TransactionIdType,ByIdFunc)
var ByIdFunc = func(n TransactionIdWithExpiry) common.TransactionIdType { return n.TrxId }

//go:generate gotemplate -outfmt "gen_%v" "github.com/eosspark/eos-go/libraries/multiindex/ordered_index" ByExpiry(TransactionIdWithExpiryIndex,TransactionIdWithExpiryIndexNode,TransactionIdWithExpiryIndexBase,TransactionIdWithExpiryIndexBaseNode,TransactionIdWithExpiry,common.TimePoint,ByExpiryFunc,ByExpireCompare,true)
