(module
 ...
 (data (i32.const 336) "memo has more than 256 bytes\00")
 (data (i32.const 368) "token with symbol does not exist, create token before issue\00")
 (data (i32.const 432) "invalid quantity\00")
 (data (i32.const 464) "must issue positive quantity\00")
 (data (i32.const 496) "symbol precision mismatch\00")
 (data (i32.const 528) "quantity exceeds available supply\00")
