...
//       };
func getPermissionLastUsed(w *WasmGo, account common.AccountName, permission common.PermissionName) int64 {
...
//       }
func getAccountCreationTime(w *WasmGo, account common.AccountName) int64 {
