...
import (
	...
	"github.com/eosspark/eos-go/wasmgo/compile"
	"github.com/eosspark/eos-go/wasmgo/disasm"
...
func NewVM(module *wasm.Module, wasmGo *WasmGo) (*VM, error) {
	var vm VM
	...
	for i, fn := range module.FunctionIndexSpace {
		...
		if len(fn.Name) > 1 {
			vm.funcs[i] = eosFunction{
				function: wasmGo.GetHandle(fn.Name),
			}
			nNatives++
			continue
		}
